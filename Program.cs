...
namespace AdventOfCode2022
{
    class Program
    {
        static void Main(string[] args) {
            ...
            //Console.WriteLine($"{day9.SolvePartOne(1)} (Example)");
            //Console.WriteLine($"{day9.SolvePartTwo(1)} (Example)");
            //Console.WriteLine($"{day9.SolvePartOne(0)} (Actual)");
            //Console.WriteLine($"{day9.SolvePartTwo(0)} (Actual)");

            //Day10 day10 = new Day10("Inputs\\Day10_Input.txt", new List<String> { "Inputs\\Day10_Example.txt" });
            //Console.WriteLine($"{day10.SolvePartOne(1)} (Example)");
            //Console.WriteLine($"{day10.SolvePartTwo(1)} (Example)");
            //Console.WriteLine($"{day10.SolvePartOne(0)} (Actual)");
            //Console.WriteLine($"{day10.SolvePartTwo(0)} (Actual)");

            //Day11 day11 = new Day11("Inputs\\Day11_Input.txt", new List<String> { "Inputs\\Day11_Example.txt" });
            //Console.WriteLine($"{day11.SolvePartOne(1)} (Example)");
            //Console.WriteLine($"{day11.SolvePartTwo(1)} (Example)");
            //Console.WriteLine($"{day11.SolvePartOne(0)} (Actual)");
            //Console.WriteLine($"{day11.SolvePartTwo(0)} (Actual)");



            //Day12 day12 = new Day12("Inputs\\Day12_Input.txt", new List<String> { "Inputs\\Day12_Example.txt" });
            //Console.WriteLine($"{day12.SolvePartOne(1)} (Example)");
            //Console.WriteLine($"{day12.SolvePartTwo(1)} (Example)");
            //Console.WriteLine($"{day12.SolvePartOne(0)} (Actual)");
            //Console.WriteLine($"{day12.SolvePartTwo(0)} (Actual)");


            //Day13 Day13 = new Day13("Inputs\\Day13_Input.txt", new List<String> { "Inputs\\Day13_Example.txt" });
            //Console.WriteLine($"{Day13.SolvePartOne(1)} (Example)");
            //Console.WriteLine($"{Day13.SolvePartTwo(1)} (Example)");
